#define DEPTH_OF_FIELD //Enables or disables depth of field.
...
#define DOF_STRENGTH 0.50 //Sample stregth used for the depth of field. [0.25 0.30 0.35 0.40 0.45 0.50 0.55 0.60 0.65 0.70 0.75 0.80 0.85 0.90 0.95 1.00 1.05 1.10 1.15 1.20 1.25 1.30 1.35 1.40 1.45 1.50 1.55 1.60 1.65 1.70 1.75 1.80 1.85 1.90 1.95 2.00]
#define DOF_RADIUS 1 //Sample radius used for the depth of field. [1 2 4 8 16 32 64]
...
vec3 DoF(in sampler2D tex, in vec2 coord, vec3 c, float z) {
    ...
    float coc = max(abs(z - centerDepthSmooth) * DOF_STRENGTH * 0.5, 0.0);
